...
frontend/
  ...
  src/
    ...
    components/
      ...
      Graph3D.tsx            - 3D graph scene with a top-left brain mesh toggle, enlarged brain shell, dodecahedron nodes, force-directed layout, animated node-to-node focus transitions, concept dive-in with document sub-graph, and callback props (onOpenDocument, onConceptFocused) for parent tab integration
